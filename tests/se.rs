...
fn se_manual_tests() {
    ...
    se_manual_test( "{\"key\":\"blZ9VO3AZxbHbv7RflznaEvWC7j3X1FH6pOTwpcYqo4=\",\"algorithm\":\"se-aesgcm256\"}",
                    ...
                    "{\"ciphertext\":\"AAAAAAAAAAAAAAAAtdJTGLXxsArHcNkIA3LwAMaKEzTcMXDwmKnh5izO04EMsMTg0Ho=\",\"algorithm\":\"se-aesgcm256\"}",
    ...
    se_manual_test( "{\"key\":\"bd6QR9EkrVX9Aq-eCfukKgt_uv6kj5OdFodx6MSwaZ4=\",\"algorithm\":\"se-aesgcm256\"}",
                    ...
                    "{\"algorithm\":\"se-aesgcm256\",\"ciphertext\":\"EuoKbWVgDB-KZhc6BYNxzXvJPAMQps_ra9mmtMQAvdo66Ur8fWppIgIOwOcouCdUNoY=\"}", 
                    "this is some plaintext".to_owned().into_bytes());
    ...
    se_manual_test( "{\"key\":\"PZ_f3UfYRiAqM99sd4hRwEMVdzYoxjLrPR65grAeSSY=\",\"algorithm\":\"se-aesgcm256\"}",
                    ...
                    "{\"algorithm\":\"se-aesgcm256\",\"ciphertext\":\"AAAAAAAAAAAAAAAALxZa756HxuCOh0hXH8AF-5VBH3MDohg3YOkP6s91R6PT1HCJ2BA=\"}",
                    "this is some plaintext".to_owned().into_bytes());
}
